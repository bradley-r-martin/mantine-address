# country-state-regions Specification

## Purpose

Define country and region types, exports, and how canonical country lists and per-country state data integrate with `AddressInput`.
