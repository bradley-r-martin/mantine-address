...
(All other requirements in the documentation spec—.gitignore, contribution documentation—remain unchanged; only the requirement above is modified to use "provider" instead of "adapter".)
