...
- **FROM:** Class and file `GooglePlacesAdapter` (implements `AddressLookupAdapter`)
- **TO:** `GooglePlacesProvider` (implements `AddressLookupProvider`), in `providers/GooglePlacesProvider.ts`

- **FROM:** Terminology "adapter" in requirement text
- **TO:** "provider"
